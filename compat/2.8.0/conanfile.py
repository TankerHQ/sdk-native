...
class Compat(ConanFile):
    ...
    def requirements(self):
        ...
        self.requires("jsonformoderncpp/3.8.0#a5aa536c8f57f0270dde99b4507f713b", override=True)
        ...
        self.requires("fetchpp/0.12.4#6d75dc33b821a84db3bbeafbb4b3ca5a", override=True)
