...
class TankerConan(ConanFile):
    ...
    def requirements(self):
        ...
        self.requires("boost/1.78.0-r7", private=private)
        ...
        if self.options.with_sqlite:
            ...
            self.requires("sqlpp11-connector-sqlite3/0.30-r5", private=private)
        self.requires("mgs/0.2.1-r1", private=private)
        self.requires("enum-flags/0.1a-r2", private=private)
        ...
        self.requires("tconcurrent/0.40.0-r4", private=private)
    ...
    def build_requirements(self):
        ...
        if self.should_build_tests:
            self.test_requires("catch2-async/3.2.1-r1")
