...
class TankerConan(ConanFile):
    ...
    def requirements(self):
        ...
        self.requires("tconcurrent/0.19.0@tanker/stable", private=private)
    ...
    def package_info(self):
        libs = ["ctanker", "tankercore_test", "tankercompathelpers", "tankertesthelpers", "tankercore", "tankeridentity", "tankercrypto", "tankerserialization", "tankerformat"]
