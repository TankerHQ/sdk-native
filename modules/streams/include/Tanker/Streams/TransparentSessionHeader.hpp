...
public:
  ...
  static constexpr std::uint32_t serializedSize =
      versionSize + Crypto::SimpleResourceId::arraySize + Crypto::SubkeySeed::arraySize + sizeof(std::uint32_t);
...
private:
  friend void from_serialized(Serialization::SerializedSource&, TransparentSessionHeader&);
...
void from_serialized(Serialization::SerializedSource&, TransparentSessionHeader&);
