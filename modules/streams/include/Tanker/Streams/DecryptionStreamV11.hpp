...
{
class DecryptionStreamV11 : public DecryptionStream<DecryptionStreamV11, TransparentSessionHeader>
{
  friend DecryptionStream<DecryptionStreamV11, TransparentSessionHeader>;

private:
  explicit DecryptionStreamV11(InputSource cb, TransparentSessionHeader header, Crypto::SymmetricKey key);
