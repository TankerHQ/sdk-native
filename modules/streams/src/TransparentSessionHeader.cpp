...
{
TransparentSessionHeader::TransparentSessionHeader(
                     ...
                     TransparentSessionHeader& header)
{
  ...
  auto const resourceIdData =
      ss.read(SimpleResourceId::arraySize + SubkeySeed::arraySize);
  std::copy(resourceIdData.begin(),
            resourceIdData.end(),
            header._resourceId.begin() + 1);
