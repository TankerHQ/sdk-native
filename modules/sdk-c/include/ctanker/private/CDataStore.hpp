...
public:
  ...
  std::unique_ptr<Tanker::DataStore::DataStore> open(std::string const& dataPath,
                                                     std::string const& cachePath) override;
...
{
public:
  CTankerStorageDataStore(tanker_datastore_options_t options, tanker_datastore_t* store);
