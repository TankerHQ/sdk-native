...
namespace Actions
{
UserGroupCreation2::UserGroupCreation2(TrustchainId const& trustchainId,
...
std::vector<std::uint8_t> UserGroupCreation2::signatureData() const
{
  std::vector<std::uint8_t> signatureData(
      ...
      (_provisionalMembers.size() *
       (Crypto::PublicSignatureKey::arraySize * 2 + Crypto::TwoTimesSealedPrivateEncryptionKey::arraySize)));
...
TANKER_TRUSTCHAIN_ACTION_DEFINE_METHODS(UserGroupCreation2, TANKER_TRUSTCHAIN_ACTIONS_USER_GROUP_CREATION_V2_ATTRIBUTES)
}
}
}
