...
namespace Actions
{
UserGroupCreation1::UserGroupCreation1(TrustchainId const& trustchainId,
...
std::vector<std::uint8_t> UserGroupCreation1::signatureData() const
{
  std::vector<std::uint8_t> signatureData(
      ...
      (_sealedPrivateEncryptionKeysForUsers.size() *
       (Crypto::PublicEncryptionKey::arraySize + Crypto::SealedPrivateEncryptionKey::arraySize)));
...
TANKER_TRUSTCHAIN_ACTION_DEFINE_METHODS(UserGroupCreation1, TANKER_TRUSTCHAIN_ACTIONS_USER_GROUP_CREATION_V1_ATTRIBUTES)
}
}
}
