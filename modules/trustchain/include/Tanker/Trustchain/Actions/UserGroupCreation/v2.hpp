...
public:
  ...
  TANKER_IMMUTABLE_ACTION_IMPLEMENTATION(UserGroupCreation2,
                                         TANKER_TRUSTCHAIN_ACTIONS_USER_GROUP_CREATION_V2_ATTRIBUTES)

public:
  UserGroupCreation2(TrustchainId const& trustchainId,
...
private:
  friend void from_serialized(Serialization::SerializedSource&, UserGroupCreation2&);
};
