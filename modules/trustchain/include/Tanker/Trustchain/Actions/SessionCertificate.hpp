...
#define TANKER_TRUSTCHAIN_ACTIONS_SESSION_CERTIFICATE_ATTRIBUTES               \
  (sessionPublicSignatureKey, Crypto::PublicSignatureKey),                     \
      (timestamp, uint64_t), (verificationMethodType, VerificationMethodType), \
      (verificationMethodTarget, Crypto::Hash)
