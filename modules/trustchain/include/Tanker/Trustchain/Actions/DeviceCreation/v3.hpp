...
#define TANKER_TRUSTCHAIN_ACTIONS_DEVICE_CREATION_V3_ATTRIBUTES                                                   \
  (ephemeralPublicSignatureKey, Crypto::PublicSignatureKey), (userId, UserId),                                    \
      ...
      (publicEncryptionKey, Crypto::PublicEncryptionKey), (publicUserEncryptionKey, Crypto::PublicEncryptionKey), \
      (sealedPrivateUserEncryptionKey, Crypto::SealedPrivateEncryptionKey), (isGhostDevice, bool)
...
public:
  ...
  TANKER_IMMUTABLE_ACTION_IMPLEMENTATION(DeviceCreation3, TANKER_TRUSTCHAIN_ACTIONS_DEVICE_CREATION_V3_ATTRIBUTES)

public:
  DeviceCreation3(TrustchainId const& trustchainId,
...
private:
  friend void from_serialized(Serialization::SerializedSource&, DeviceCreation3&);
};
