...
#define TANKER_DETAIL_ATTRIBUTE_NAME(elem) BOOST_PP_CAT(_, BOOST_PP_TUPLE_ELEM(0, elem))
...
#define TANKER_DETAIL_FULL_PARAMETER(elem) TANKER_DETAIL_TYPE_NAME(elem) const& TANKER_DETAIL_PARAMETER_NAME(elem)
