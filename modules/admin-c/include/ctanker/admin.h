 ...
 */
TANKER_ADMIN_C_EXPORT tanker_future_t* tanker_admin_connect(char const* app_management_url,
 ...
 */
TANKER_ADMIN_C_EXPORT tanker_future_t* tanker_admin_create_app(tanker_admin_t* admin, char const* name);
 ...
 */
TANKER_ADMIN_C_EXPORT tanker_future_t* tanker_admin_delete_app(tanker_admin_t* admin, char const* app_id);

/*!
 * Frees the app descriptor structure
 */
TANKER_ADMIN_C_EXPORT void tanker_admin_app_descriptor_free(tanker_app_descriptor_t* app);
 ...
 */
TANKER_ADMIN_C_EXPORT tanker_future_t* tanker_admin_destroy(tanker_admin_t* admin);
#ifdef __cplusplus
}
#endif
