...
public:
  ...
  static std::uint64_t encryptedSize(std::uint64_t clearSize, std::optional<std::uint32_t> paddingStep);
  ...
  static tc::cotask<std::uint64_t> decrypt(gsl::span<uint8_t> decryptedData,
