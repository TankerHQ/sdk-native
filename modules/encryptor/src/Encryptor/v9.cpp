...
std::uint64_t EncryptorV9::decryptedSize(gsl::span<std::uint8_t const> encryptedData)
{
...
tc::cotask<EncryptCacheMetadata> EncryptorV9::encrypt(gsl::span<std::uint8_t> encryptedData,
...
tc::cotask<std::uint64_t> EncryptorV9::decrypt(gsl::span<std::uint8_t> decryptedData,
...
CompositeResourceId EncryptorV9::extractResourceId(gsl::span<std::uint8_t const> encryptedData)
{
  checkEncryptedFormat(encryptedData);
