...
std::uint64_t EncryptorV3::decryptedSize(gsl::span<std::uint8_t const> encryptedData)
{
...
tc::cotask<EncryptCacheMetadata> EncryptorV3::encrypt(gsl::span<std::uint8_t> encryptedData,
...
tc::cotask<std::uint64_t> EncryptorV3::decrypt(gsl::span<std::uint8_t> decryptedData,
...
SimpleResourceId EncryptorV3::extractResourceId(gsl::span<std::uint8_t const> encryptedData)
{
  checkEncryptedFormat(encryptedData);
