 ...
 *         future.
 */
TANKER_ASYNC_EXPORT tanker_future_t* tanker_promise_get_future(tanker_promise_t* promise);

/*!
 * Set a promise value.
 * \pre promise parameter must be allocated with tanker_promise_create().
 */
TANKER_ASYNC_EXPORT void tanker_promise_set_value(tanker_promise_t* promise, void* value);
 ...
 */
TANKER_ASYNC_EXPORT tanker_future_t* tanker_future_then(tanker_future_t* future, tanker_future_then_t cb, void* arg);
 ...
 */
TANKER_ASYNC_EXPORT tanker_error_t* tanker_future_get_error(tanker_future_t* future);
 ...
 */
TANKER_ASYNC_EXPORT unsigned char tanker_future_has_error(tanker_future_t* future);
