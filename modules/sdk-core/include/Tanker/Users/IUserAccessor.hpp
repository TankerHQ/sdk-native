...
public:
  ...
  virtual tc::cotask<UserPullResult> pull(std::vector<Trustchain::UserId> userIds) = 0;
  virtual tc::cotask<DevicePullResult> pull(std::vector<Trustchain::DeviceId> deviceIds) = 0;
