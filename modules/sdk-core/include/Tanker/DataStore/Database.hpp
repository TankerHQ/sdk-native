...
public:
  ...
  tc::cotask<void> putFullGroup(InternalGroup const& group) override;
  ...
  tc::cotask<nonstd::optional<InternalGroup>> findFullGroupByGroupId(
  ...
  tc::cotask<nonstd::optional<InternalGroup>> findFullGroupByGroupPublicEncryptionKey(
