...
public:
  ...
  virtual tc::cotask<nonstd::optional<Crypto::PublicSignatureKey>>
  ...
  virtual tc::cotask<void> putFullGroup(InternalGroup const& group) = 0;
  ...
  virtual tc::cotask<nonstd::optional<InternalGroup>> findFullGroupByGroupId(
