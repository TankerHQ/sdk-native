...
{
public:
  MAKE_MOCK1(postResourceKeys, tc::cotask<void>(Share::ShareActions const&), override);
  MAKE_MOCK2(getEncryptionKey,
  ...
  MAKE_MOCK1(
      getKeyPublishes,
      tc::cotask<std::vector<Trustchain::KeyPublishAction>>(gsl::span<Crypto::SimpleResourceId const> resourceIds),
      override);
