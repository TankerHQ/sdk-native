...
struct TestVector
{
  ...
  TestVector(std::vector<uint8_t> const& key,
    ...
    : key(key), clearData(clearData), encryptedData(encryptedData)
  {
  }
};
...
struct TestContext<EncryptorV2>
{
  ...
  std::vector<TestVector> testVectors{
      {{0x76, 0xd,  0x8e, 0x80, 0x5c, 0xbc, 0xa8, 0xb6, 0xda, 0xea, 0xcf,
       ...
       {0x02, 0x32, 0x93, 0xa3, 0xf8, 0x6c, 0xa8, 0x82, 0x25, 0xbc,
        0x17, 0x7e, 0xb5, 0x65, 0x9b, 0xee, 0xd,  0xfd, 0xcf, 0xc6,
        0x5c, 0x6d, 0xb4, 0x72, 0xe0, 0x5b, 0x33, 0x27, 0x4c, 0x83,
        0x84, 0xd1, 0xad, 0xda, 0x5f, 0x86, 0x2,  0x46, 0x42, 0x91,
        0x71, 0x30, 0x65, 0x2e, 0x72, 0x47, 0xe6, 0x48, 0x20, 0xa1,
        0x86, 0x91, 0x7f, 0x9c, 0xb5, 0x5e, 0x91, 0xb3, 0x65, 0x2d}},
  };
};
...
struct TestContext<EncryptorV3>
{
  ...
  std::vector<TestVector> testVectors{
      {{0x76, 0xd,  0x8e, 0x80, 0x5c, 0xbc, 0xa8, 0xb6, 0xda, 0xea, 0xcf,
        ...
        0xce, 0x77, 0x35, 0x8e, 0xa8, 0x31, 0xd7, 0x2f, 0x14, 0xdd},
       make_buffer("this is very secret"),
       {0x03, 0x37, 0xb5, 0x3d, 0x55, 0x34, 0xb5, 0xc1, 0x3f,
        0xe3, 0x72, 0x81, 0x47, 0xf0, 0xca, 0xda, 0x29, 0x99,
        0x6e, 0x4,  0xa8, 0x41, 0x81, 0xa0, 0xe0, 0x5e, 0x8e,
        0x3a, 0x8,  0xd3, 0x78, 0xfa, 0x5,  0x9f, 0x17, 0xfa}},
  };
};
