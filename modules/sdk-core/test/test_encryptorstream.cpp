...
TEST_CASE(
    "EncryptorStream: decryptedSize and encryptedSize should be symmetrical")
{
...
TEST_CASE("EncryptorStream: encryptedSize should return the right size")
{
...
TEST_CASE("EncryptorStream: encrypt/decrypt should work with an empty buffer")
{
...
TEST_CASE(
    "EncryptorStream: should not be able to decrypt a corrupted empty buffer")
{
  std::vector<uint8_t> clearData;
  std::vector<uint8_t> encryptedData(
      EncryptorV4::encryptedSize(clearData.size()));
...
TEST_CASE("EncryptorStream: encrypt/decrypt should work with a normal buffer")
{
...
TEST_CASE("EncryptorStream: encrypt/decrypt should work with a large buffer")
{
  std::vector<uint8_t> clearData(
...
TEST_CASE("EncryptorStream: encrypt should never give the same result twice")
{
  auto clearData = make_buffer("this is the data to encrypt");
...
TEST_CASE("EncryptorStream: Should be able to decrypt an empty test buffer")
{
  std::vector<uint8_t> clearData;
...
TEST_CASE("EncryptorStream: Should be able to decrypt a test vector V4")
{
...
TEST_CASE(
    "EncryptorStream: Should be able to decrypt a test vector V4 with multiple "
    "chunks")
{
  auto clearData = make_buffer("this is a secret");
